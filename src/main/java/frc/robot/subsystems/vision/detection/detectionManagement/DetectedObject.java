...
public class DetectedObject {
  ...
  public double getConfidence() {
    // here add logic to give it zero confidence if there aren't enough detections OR if the last
    // detection was to long ago
  ...
  public double getCorrelation(Detection detection) {
    ...
    double distance =
        detection
            .getPosition()
            .getTranslation()
            .getDistance(getEstimatedPosition().getTranslation());
