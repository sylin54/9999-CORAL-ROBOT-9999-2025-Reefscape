...
public class Detection {
  ...
  public Detection(double detectionTimeSec, Pose2d position, int id) {
    this.detectionTimeSec = detectionTimeSec;
    this.position = position;
    this.id = id;
  }

  public Detection(double detectionTimeSec, Translation2d position, int id) {
    this(detectionTimeSec, new Pose2d(position, new Rotation2d()), id);
  }
  ...
  /**
   * @return the id of the deteciton
   */
  public int getID() {
    return id;
  }
