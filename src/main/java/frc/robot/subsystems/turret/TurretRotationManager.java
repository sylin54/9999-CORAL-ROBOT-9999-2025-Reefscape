...
public class TurretRotationManager {
    ...
    public double getDistance() {
        double distance = targetPose.get().getTranslation().getDistance(robotPose.get().getTranslation());
    ...
    /**
     * converts the rotation to an encoder value on the motor so we can rotate it towards it(MAYBE MOVE INTO MOTOR CLASS)
